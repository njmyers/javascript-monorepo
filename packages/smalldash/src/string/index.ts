...
export { default as kebabToPascal } from './kebab-to-pascal';
...
export { default as sentenceToPascal } from './sentence-to-pascal';
...
export { default as snakeToPascal } from './snake-to-pascal';
export { default as snakeToSentence } from './snake-to-sentence';
export { default as snakeToTitle } from './snake-to-title';
