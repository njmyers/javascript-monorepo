...
const universalOptions = {
  ...
  error: (props) => {
    ...
    return (
      <div>
        An error occurred loading this page's template. More information is
...
const t_0 = universal(import('../src/pages/projects'), universalOptions);
const t_1 = universal(import('../src/templates/project'), universalOptions);
