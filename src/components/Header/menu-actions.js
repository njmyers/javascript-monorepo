...
export const menuState = (payload) => ({ type: 'MENU_STATE', key: 'isMenuOn', payload });
export const animateMenu = (payload) => ({ type: 'ANIMATE_MENU', key: 'mobileMenuStyle', payload });
export const setOrientation = (payload) => ({ type: 'ORIENTATION', key: 'orientation', payload });
