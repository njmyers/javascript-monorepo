...
const tablet = (sizes) => sizes.window.innerWidth < 1440 && sizes.window.innerWidth >= 768;
...
const SizedLorem = Size({ component: true, mobile: true, orientation: true, inView: true, custom })(
    LoremIpsum
);
